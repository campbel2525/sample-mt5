...
`<user名>`、`<session id>`は自分の環境に置き換えること

WSL 上のパスで`/mnt/c/Users/<user名>/AppData/Roaming/MetaQuotes/Terminal/<session id>/MQL5/Experts/WSL2_FileBridge.mq5`
...
```
vi /mnt/c/Users/<user名>/AppData/Roaming/MetaQuotes/Terminal/<session id>/MQL5/Experts/WSL2_FileBridge.mq5
```
